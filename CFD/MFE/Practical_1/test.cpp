...
int main()
{
    double x0 = 0, x1 = 1, y0 = 0, y1 = 1, T = 0.05, gamma = 1.4, nxCells = 100, nyCells = 100;
    double dx = (x1 - x0)/nxCells;
    double dy = (y1 - y0)/nyCells;
    mat u0;
    ...
    // double x0 = 0, x1 = 2, y0 = 0, y1 = 2, T = 0.25, gamma = 1.4, nxCells = 100, nyCells = 100;
    // double dx = (x1 - x0)/nxCells;
    // double dy = (y1 - y0)/nyCells;
    // mat u0;
    // u0.resize(nxCells+2, vector<array<double, 4>> (nyCells+2));
    ...
    //Liu and Lax
    // double x0 = 0, x1 = 1, y0 = 0, y1 = 1, T = 0.2, gamma = 1.4, nxCells = 200, nyCells = 200;
    // double dx = (x1 - x0)/nxCells;
    // double dy = (y1 - y0)/nyCells;
    // mat u0;
    // u0.resize(nxCells+2, vector<array<double, 4>> (nyCells+2));
